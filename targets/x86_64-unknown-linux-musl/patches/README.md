...
- Source: Bloomberg Clang P2996 (C++26 Reflection)
- Based on LLVM 21.0.0
- Matches our `llvm` submodule pin: branch `p2996`
...
alignment guarantees this *fuzz-tolerant*
...
LLVM releases (including 21.0.0 / 22.x), so a small fuzz/offset is expected and
intentional. Verified: all three patches apply at default fuzz on the
pinned source (0002 Hunk #1 succeeds with fuzz 2).
