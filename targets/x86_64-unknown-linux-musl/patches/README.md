...
- aports commit: `8b4d1f88aca8bd81cda4422a6cafaf11813d8a07` (2026-06-17)
- aports `llvm-runtimes` `pkgver=22.1.8`
- Matches our `llvm` submodule pin: tag `llvmorg-22.1.8`
...
alignment (LLVM 22.1.8 with aports 22.1.8) guarantees this *fuzz-tolerant*
...
LLVM releases (including 22.1.8, which has a `SANITIZER_HAIKU` block between the
...
pinned 22.1.8 source (0002 Hunk #1 succeeds with fuzz 2).
